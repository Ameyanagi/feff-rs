...
pub use amplitude::{calculate_exafs_spectrum, calculate_path_exafs, ExafsParameters};
pub use degeneracy::{calculate_path_degeneracies, calculate_single_path_degeneracy};
pub use filter::{
    cluster_paths_by_length, filter_paths, select_optimal_path_set, PathFilterConfig,
};
...
mod tests {
    ...
    fn test_path_finder() {
        ...
        let single_scattering_count = paths
            .iter()
    ...
    fn test_path_degeneracy() {
        ...
        let degenerate_paths = calculate_path_degeneracies(
            paths, &structure, 0.01, // angle tolerance in radians
