...
use feff_rs::utils::{
    angstrom_to_bohr, bohr_to_angstrom, ev_to_hartree, hartree_to_ev, constants,
};
...
fn test_unit_conversions() {
    ...
    assert_relative_eq!(bohr_value, angstrom_value / constants::BOHR_RADIUS, epsilon = 1e-10);
    ...
    assert_relative_eq!(hartree_value, ev_value / (2.0 * constants::RYDBERG), epsilon = 1e-10);
}